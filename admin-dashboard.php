...
<body class="admin-overview admin-shell" data-theme="light"><?php require_once __DIR__ . '/includes/mobile_app_nav.php'; require __DIR__ . '/includes/notification_bell.php'; ?>
