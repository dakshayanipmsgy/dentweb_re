...
function documents_document_style_defaults(): array
{
    return [
        'theme' => [
            ...
            'danger_color' => '#dc2626',
            'chart_green_color' => '#16a34a',
            'chart_yellow_color' => '#f59e0b',
            'chart_red_color' => '#dc2626',
        ],
        'typography' => [
            'base_font_size_px' => 14,
            'print_base_font_size_px' => 10,
            'h1_px' => 26,
            'h2_px' => 20,
            'h3_px' => 16,
            'line_height' => 1.45,
        ...
        'layout' => [
            ...
            'print_scale' => 0.92,
            'print_backgrounds_enabled' => true,
            'compact_print_mode' => true,
        ],
        'defaults' => [
...
function documents_quote_defaults(): array
{
    return [
        ...
        'financial_inputs' => [
            ...
            'loan_method' => 'pm_subsidy_reduces_principal',
            'show_subsidy_in_emi_logic' => true,
        ...
        'financial_calc' => [
            ...
            'effective_loan_principal_for_emi' => 0,
            'emi' => 0,
