...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'save_invoice_draft') {
        ...
        $message = !documents_invoice_has_quotation_reference($doc) ? 'Legacy project invoice draft saved.' : (documents_invoice_has_price_adjustment($doc)
