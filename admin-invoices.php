...
foreach (glob(documents_invoices_dir() . '/*.json') ?: [] as $file) {
    ...
    if (is_array($row)) {
        $merged = documents_invoice_normalize_commercial_snapshot(array_merge(documents_invoice_defaults(), $row));
