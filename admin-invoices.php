...
<script>
const invoiceVariants=<?=json_encode($invoiceVariantsByComponent,JSON_HEX_TAG|JSON_HEX_AMP|JSON_HEX_APOS|JSON_HEX_QUOT)?>, invoiceRates=<?=json_encode($invoiceQuoteDefaults['rate_chart']??[],JSON_HEX_TAG|JSON_HEX_AMP|JSON_HEX_APOS|JSON_HEX_QUOT)?>;
