...
$tab = safe_text($_GET['tab'] ?? 'challans');
if (!in_array($tab, ['challans', 'create', 'archived'], true)) { $tab = 'challans'; }
...
$rows = array_values(array_filter(documents_list_challans(), static function (array $row) use ($filters, $tab): bool {
...
<nav class="commercial-flow-strip" aria-label="Commercial lifecycle"><a href="admin-quotations.php">Quotation</a><span>→</span><a href="admin-agreements.php">Agreement</a><span>→</span><a class="active" href="admin-challans.php">Challan</a><span>→</span><a href="admin-invoices.php">Invoice</a><span>→</span><a href="admin-receipts.php">Receipt</a></nav>
<div data-workspace-root><nav class="workspace-tabs" data-workspace-tabs="fetch" aria-label="Challan workspace"><a data-workspace-tab class="<?= $tab === 'challans' ? 'active' : '' ?>" href="?tab=challans">Challans</a><a data-workspace-tab class="<?= $tab === 'create' ? 'active' : '' ?>" href="?tab=create">Create Challan</a><a data-workspace-tab class="<?= $tab === 'archived' ? 'active' : '' ?>" href="?tab=archived">Archived</a></nav>
