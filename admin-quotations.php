...
<div><label>Loan amount ₹</label><input type="number" step="0.01" name="loan_amount" value="<?= htmlspecialchars((string)($editing['finance_inputs']['loan']['loan_amount'] ?? ''), ENT_QUOTES) ?>" data-has-saved-value="<?= ($editingId !== '' && trim((string)($editing['finance_inputs']['loan']['loan_amount'] ?? '')) !== '') ? '1' : '0' ?>"></div>
<div><label><input type="checkbox" name="loan_enabled" <?= !empty($editing['finance_inputs']['loan']['enabled']) ? 'checked' : '' ?>> Loan enabled</label></div>
<div><label>Loan interest %</label><input type="number" step="0.01" name="loan_interest_pct" value="<?= htmlspecialchars((string)($editing['finance_inputs']['loan']['interest_pct'] ?? ''), ENT_QUOTES) ?>" data-has-saved-value="<?= ($editingId !== '' && trim((string)($editing['finance_inputs']['loan']['interest_pct'] ?? '')) !== '') ? '1' : '0' ?>"></div>
<div><label>Loan tenure years</label><input type="number" step="1" name="loan_tenure_years" value="<?= htmlspecialchars((string)($editing['finance_inputs']['loan']['tenure_years'] ?? ''), ENT_QUOTES) ?>" data-has-saved-value="<?= ($editingId !== '' && trim((string)($editing['finance_inputs']['loan']['tenure_years'] ?? '')) !== '') ? '1' : '0' ?>"></div>
<div><label>Margin money ₹</label><input type="number" step="0.01" name="loan_margin_pct" value="<?= htmlspecialchars((string)($editing['finance_inputs']['loan']['margin_pct'] ?? ''), ENT_QUOTES) ?>" data-has-saved-value="<?= ($editingId !== '' && trim((string)($editing['finance_inputs']['loan']['margin_pct'] ?? '')) !== '') ? '1' : '0' ?>"><div class="muted"><a href="#" id="resetLoanDefaults">Reset to defaults</a></div></div>
