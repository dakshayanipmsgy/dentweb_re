...
<nav class="quotation-tabs" aria-label="Quotation workspace">
<a class="<?= $tab === 'quotations' ? 'active' : '' ?>" href="admin-quotations.php?tab=quotations">Quotations</a>
<a class="<?= $tab === 'archived' ? 'active' : '' ?>" href="admin-quotations.php?tab=archived">Archived</a>
<a class="<?= $tab === 'bulk' ? 'active' : '' ?>" href="admin-quotations.php?tab=bulk">Bulk Tools</a>
<a class="<?= $tab === 'settings' ? 'active' : '' ?>" href="admin-quotations.php?tab=settings">Settings</a>
<a class="primary-tab <?= $tab === 'editor' ? 'active' : '' ?>" href="admin-quotations.php?tab=editor">+ New Quotation</a>
</nav>
