...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'save_settings') {
        ...
        $d['global']['ui_tokens']['header_footer']['header_text_color'] = safe_text($_POST['header_text_color_hex'] ?? ($_POST['header_text_color'] ?? ($d['global']['ui_tokens']['header_footer']['header_text_color'] ?? '#ffffff')));
        $d['global']['ui_tokens']['header_footer']['footer_text_color'] = safe_text($_POST['footer_text_color_hex'] ?? ($_POST['footer_text_color'] ?? ($d['global']['ui_tokens']['header_footer']['footer_text_color'] ?? '#ffffff')));
...
if ($tab === 'archived') {
    $allQuotes = array_values(array_filter($allQuotes, static function (array $q): bool {
        return strtolower((string)($q['status'] ?? 'Draft')) !== 'draft';
    }));
}
if ($statusFilter !== '') {
