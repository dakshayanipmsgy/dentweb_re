...
if (safe_text($_GET['action'] ?? '') === 'download_quotation_reference_data') {
    $zipPath = documents_quote_import_reference_bundle_path();
    header('Content-Type: application/zip');
    header('Content-Disposition: attachment; filename="quotation-reference-data.zip"');
...
<div class="quick-action-buttons"><a class="btn secondary" href="admin-quotations.php?tab=bulk_create&amp;action=download_quotation_csv_template">Download quotation CSV template</a><a class="btn secondary" href="admin-quotations.php?tab=bulk_create&amp;action=download_quotation_reference_data">Download current reference bundle</a></div>
