...
<h3>Solar Panel Layout Designer</h3><input type="hidden" name="panel_orientation_json" id="panelOrientationJson" value="<?= htmlspecialchars(json_encode(['grid'=>$orientation['grid'] ?? ['columns'=>48,'rows'=>32,'cell_size_editor_px'=>14,'snap_unit'=>1,'cell_unit'=>'grid'], 'objects'=>$orientation['objects'] ?? []], JSON_UNESCAPED_SLASHES|JSON_UNESCAPED_UNICODE), ENT_QUOTES) ?>"><div class="panel-layout-designer" data-panel-layout-designer data-initial-layout="<?= htmlspecialchars(json_encode(['grid'=>$orientation['grid'] ?? ['columns'=>48,'rows'=>32,'cell_size_editor_px'=>14,'snap_unit'=>1,'cell_unit'=>'grid'], 'objects'=>$orientation['objects'] ?? []], JSON_UNESCAPED_SLASHES|JSON_UNESCAPED_UNICODE), ENT_QUOTES) ?>"><div class="panel-layout-toolbar"><div><strong>Drag palette items to the grid</strong><div class="muted">Panels and labels snap to grid units; overlaps are rejected.</div></div><div class="panel-layout-actions"><button type="button" class="btn secondary" data-layout-zoom="out">Zoom out</button><span class="panel-layout-zoom" data-layout-zoom-label>100%</span><button type="button" class="btn secondary" data-layout-zoom="in">Zoom in</button><button type="button" class="btn secondary" data-layout-zoom="fit">Fit to screen</button><button type="button" class="btn secondary" data-layout-reset>Reset</button><button type="button" class="btn secondary" data-layout-clear>Clear</button></div></div><div class="panel-layout-main"><div class="panel-layout-grid" data-layout-grid tabindex="0" aria-label="Solar panel layout grid"></div><aside class="panel-layout-palette"><button type="button" data-add-layout-item="panel-portrait">Portrait panel</button><button type="button" data-add-layout-item="panel-landscape">Landscape panel</button><button type="button" data-add-layout-item="text">Text label</button><button type="button" data-add-layout-item="obstruction">Keep-out</button><button type="button" data-add-layout-item="arrow">North arrow</button><hr><input data-layout-text placeholder="Selected label/text"><div class="panel-layout-nudges"><button type="button" data-layout-move="up">↑</button><button type="button" data-layout-move="left">←</button><button type="button" data-layout-move="right">→</button><button type="button" data-layout-move="down">↓</button></div><button type="button" data-layout-rotate>Rotate</button><button type="button" data-layout-duplicate>Duplicate</button><button type="button" data-layout-delete>Delete</button><div class="panel-layout-status" data-layout-status>Ready</div></aside></div><div class="muted">This designer is preferred for public rendering when objects are present; the group table below remains as fallback/summary data.</div></div>
