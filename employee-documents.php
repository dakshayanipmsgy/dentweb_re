...
<head>
  ...
  <style>
    ...
    .btn { display:inline-block; margin-top:1rem; text-decoration:none; background:#1d4ed8; color:#fff; padding:0.55rem 0.85rem; border-radius:8px; margin-right:0.5rem; }
