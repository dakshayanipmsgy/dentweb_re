...
<main class="invoice-page">
  ...
  <section class="invoice-sheet" aria-label="Invoice document">
    <header class="invoice-top">
      ...
      <div class="invoice-title"><h1>Tax Invoice</h1><p><strong><?= $esc($invoice['invoice_no'] ?: $invoice['id']) ?></strong></p><p><span class="invoice-pill"><?= $esc($invoice['status'] ?? 'Draft') ?></span></p></div>
    </header>
    <div class="invoice-inner">

    <section class="meta-grid">
      <div class="info-card"><h2>Invoice details</h2><div class="detail-row"><span>Invoice date</span><strong><?= $esc($invoiceDate ?: '—') ?></strong></div><div class="detail-row"><span>Invoice ID</span><strong><?= $esc($invoice['id']) ?></strong></div><div class="detail-row"><span>Total Solar Size</span><strong><?= $displaySolarKwp > 0 ? $esc(number_format($displaySolarKwp, 2, '.', '')) . ' kWp' : '—' ?></strong></div></div>
