...
<main class="invoice-page">
  ...
  <section class="invoice-sheet" aria-label="Invoice document">
    ...
    <section class="summary-grid"><div class="info-card accent"><h2>Payment reconciliation</h2><div class="detail-row"><span>Payment status</span><strong><?= $esc(documents_invoice_payment_status_label($paymentSummary['payment_status'])) ?></strong></div><div class="detail-row"><span>Invoice total</span><strong><?= $money($paymentSummary['invoice_total']) ?></strong></div><div class="detail-row"><span>Amount received</span><strong><?= $money($paymentSummary['total_received']) ?></strong></div><div class="detail-row"><span>Balance payable</span><strong><?= $money($paymentSummary['outstanding']) ?></strong></div><?php if ((float)$paymentSummary['overpayment'] > 0): ?><div class="detail-row"><span>Customer credit</span><strong><?= $money($paymentSummary['overpayment']) ?></strong></div><?php endif; ?><div class="detail-row"><span>Receipt count</span><strong><?= (int)$paymentSummary['receipt_count'] ?></strong></div><?php if (($paymentSummary['receipts'] ?? []) !== []): ?><div class="notes">Receipts: <?php foreach($paymentSummary['receipts'] as $pr): ?><?= $esc(($pr['receipt_number'] ?? $pr['id']) . ' (' . $money($pr['amount_rs']) . ')') ?> <?php endforeach; ?></div><?php endif; ?></div></section><section class="summary-grid"><div class="info-card"><h2>Pricing Summary</h2><?php foreach ($pricingRows as $row): ?><div class="detail-row"><span><?= $esc($row['label']) ?><?php if (($row['note'] ?? '') !== ''): ?><br><small><?= $esc($row['note']) ?></small><?php endif; ?></span><strong><?= $money($row['amount']) ?></strong></div><?php endforeach; ?></div><div class="info-card"><h2>Tax Summary</h2><div class="detail-row"><span>Basic Value</span><strong><?= $money($taxBreakdown['basic_total'] ?? 0) ?></strong></div><div class="detail-row"><span>Total GST</span><strong><?= $money($taxBreakdown['gst_total'] ?? 0) ?></strong></div><div class="detail-row"><span>Total incl GST</span><strong><?= $money($taxBreakdown['gross_incl_gst'] ?? $grandTotal) ?></strong></div></div></section>
