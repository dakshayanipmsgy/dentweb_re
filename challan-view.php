...
<div class="card"><h1>Delivery Challan</h1><p><strong><?= htmlspecialchars((string) $challan['challan_no'], ENT_QUOTES) ?></strong> · Status: <?= htmlspecialchars((string) $challan['status'], ENT_QUOTES) ?></p><a class="btn secondary" href="<?= htmlspecialchars($backLink, ENT_QUOTES) ?>">Back</a> <a class="btn" target="_blank" href="challan-print.php?id=<?= urlencode((string) $challan['id']) ?>">Open Printable View</a><div style="margin-top:8px;color:#64748b"><strong>To print or save PDF: use Ctrl + P.</strong></div></div>
