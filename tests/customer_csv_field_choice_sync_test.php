...
$bomPreview=customer_bulk_mobile_sync_preview($store,"\xEF\xBB\xBFmobile,name\n9876543210,Saved Name\n",[]);
field_choice_assert(($bomPreview['error']??'')==='' && $bomPreview['rows'][0]['result']==='Unchanged','UTF-8 BOM before mobile header is accepted');
