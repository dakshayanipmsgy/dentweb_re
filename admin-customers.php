...
<head>
  ...
  <title>Customer Management | Dakshayani Enterprises</title>
  <meta name="description" content="Administer Dentweb customer accounts." />
      ...
      <div>
        ...
        <p class="admin-muted">
          <?= $isEmployeePortal
            ...
            : 'Manage customers with a clean, ready-to-extend workspace.' ?>
        </p>
      </div>
    ...
    <section class="admin-section">
      <section class="users-section" aria-labelledby="customers-heading">
        ...
        <div class="users-tabs" role="tablist" aria-label="Customer archive views">
          <a class="users-tab__link<?= $customerView === 'active' ? ' is-active' : '' ?>" href="admin-customers.php?customer_view=active">Active Customers</a>
          <a class="users-tab__link<?= $customerView === 'archived' ? ' is-active' : '' ?>" href="admin-customers.php?customer_view=archived">Archived Customers</a>
        </div>
