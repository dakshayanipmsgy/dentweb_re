...
<main class="wrap">
  ...
  <div class="card">
    ...
    <a class="btn" target="_blank" href="agreement-print.php?id=<?= urlencode((string) $agreement['id']) ?>">Open Printable View</a>
    <p class="muted"><strong>To print or save PDF: use Ctrl + P.</strong></p>
  </div>
