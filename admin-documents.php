  ...
  <main class="page commercial-shell">
    ...
    <?php if ($activeTab === 'accepted_customers'): ?>
      <section class="panel">
        ...
        <?php else: ?>
          <div class="commercial-toolbar"><div><h2>Accepted Customers &amp; Receipts</h2><p class="muted-helper">Continue accepted quotations through lifecycle documents while keeping payment requests and receipts in this workspace.</p></div></div>
