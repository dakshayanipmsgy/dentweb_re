...
function create_or_update_solar_finance_quote(array $payload): array
{
    ...
    $annualGenerationPerKw = $dailyGenerationPerKw * 360;
    ...
    if (!array_key_exists('subsidy_credit_rs', $quote['customer_savings_inputs']) || $quote['customer_savings_inputs']['subsidy_credit_rs'] === null || $quote['customer_savings_inputs']['subsidy_credit_rs'] === '') {
