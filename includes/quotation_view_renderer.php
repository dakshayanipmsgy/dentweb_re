...
$mainCapacityDisplay = max(0, (float) ($quote['system_size_main_kwp'] ?? $quote['capacity_kwp'] ?? $quote['system_capacity_kwp'] ?? 0));
$complimentaryCapacityDisplay = max(0, (float) ($quote['system_size_complimentary_kwp'] ?? 0));
?>
<!doctype html>
