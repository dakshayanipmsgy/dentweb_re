...
function compute_financial_clarity(array $quote, array $calc, array $snapshot): array
{
    ...
    $mainCapacity = max(0, $toFloat($quote['main_capacity_kwp'] ?? null, 0));
    if ($mainCapacity <= 0) {
        $mainCapacity = max(0, $toFloat($quote['capacity_kwp'] ?? $quote['system_capacity_kwp'] ?? 0));
    }
    $complimentaryCapacity = max(0, $toFloat($quote['complimentary_capacity_kwp'] ?? null, 0));
    $capacity = max(0, $mainCapacity + $complimentaryCapacity);
    ...
    return [
        ...
        'main_capacity_kwp' => $mainCapacity,
        'complimentary_capacity_kwp' => $complimentaryCapacity,
