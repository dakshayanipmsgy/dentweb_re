...
<?php if ($bankFields !== []): ?><section class="card bank-card"><div class="section-kicker">Secure payment information</div><div class="h sec">Bank Details</div><div class="bank-grid"><?php foreach ($bankFields as $bankField): ?><div class="metric"><span class="metric-label"><?= htmlspecialchars((string)$bankField['label'], ENT_QUOTES) ?></span><div><?= htmlspecialchars((string)$bankField['value'], ENT_QUOTES) ?></div></div><?php endforeach; ?></div><div class="payment-warning">Please verify account details before payment. Payments should be made only to <?= htmlspecialchars($companyName, ENT_QUOTES) ?>.</div></section><?php endif; ?>
