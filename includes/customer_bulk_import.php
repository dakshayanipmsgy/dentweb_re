...
/** Normalize CSV headings, including the UTF-8 BOM commonly added by Excel. */
function customer_bulk_normalise_header(mixed $value): string
{
...
function customer_bulk_mobile_sync_preview(CustomerFsStore $store, string $contents, ?array $quotes = null): array
{
    ...
    $header=array_map('customer_bulk_normalise_header',$header);
