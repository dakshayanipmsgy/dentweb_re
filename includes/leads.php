...
function lead_normalize_record(array $lead): array
{
    $defaults = [
        ...
        'last_call_not_picked_at' => '',
        'last_call_not_picked_by' => '',
        'assigned_to_type' => '',
        'assigned_to_id' => '',
        'assigned_to_name' => '',
        'converted_flag' => '',
        ...
        'email_sent_at' => '',
        'email_sent_by' => '',
        'whatsapp_details_sent' => false,
        'whatsapp_details_sent_at' => '',
        'whatsapp_details_sent_by' => '',
        'email_details_sent' => false,
        'email_details_sent_at' => '',
        'email_details_sent_by' => '',
