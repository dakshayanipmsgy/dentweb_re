...
function render_material_document(array $doc, array $company, array $items, array $options = []): void
{
    ...
    <?php if(trim((string)($options['note']??''))!==''):?><h3><?=material_document_safe((string)($options['note_title']??'Note'))?></h3><p><?=nl2br(material_document_safe((string)$options['note']))?></p><?php endif;?><p class="disclaimer"><strong>Important:</strong> <?=material_document_safe((string)($options['disclaimer']??''))?></p><?=document_signature_render($doc, 'Authorised Signatory')?><footer><?=material_document_safe((string)($options['footer']??'For Dakshayani Enterprises — Authorised Signatory'))?></footer></article><?php
}
