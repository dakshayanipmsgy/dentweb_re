...
</form><?= document_signature_admin_controls($edit, 'dispatch_advice', 'admin-dispatch-advices.php?tab=editor&edit=' . urlencode((string)$edit['id']), !$locked) ?>
