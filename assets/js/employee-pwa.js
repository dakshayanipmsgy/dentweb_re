(() => {
  ...
  addEventListener('pageshow',()=>window.TaskNotifications?.refresh?.());
  document.addEventListener('visibilitychange',()=>{if(!document.hidden)window.TaskNotifications?.refresh?.();});
